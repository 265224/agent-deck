...
Agent Deck is community-driven. The best product experiences are created by deep users of each tool. We welcome contributions of all kinds — pick an area below and start vibing.

Think of Agent Deck as having done the basics: a macOS island shell + code agent communication layer + fundamental features like notifications and terminal jump-back. Everything else can be defined by you.
...
| 2 | **IDE / Plugin Jump-back** | Support jumping back to IDE or in-IDE terminal windows, or apps with integrated code agent plugins (Cursor, VSCode, GoLand, Obsidian, etc.). | Planned | [#173](https://github.com/Octane0411/agent-deck/issues/173), [#183](https://github.com/Octane0411/agent-deck/issues/183) |
...
| 5 | **Interaction & Polish** | Better UX, UI, animations, sound design, and overall feel. [Agent Deck](https://agentdeck.app/) sets a high bar here — we welcome community ideas and contributions in this space. | Open | — |
...
| 7 | **Product Ideas: Voice, Notification Reply & More** | Voice input/output, notification-based reply, and any other ideas. If you can describe it clearly in an issue and are willing to build it into existence, it has a chance to ship to everyone. | Conditionally Open | — |
