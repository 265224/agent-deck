...
struct ControlCenterView: View {
        ...
        ScrollView(.vertical) {
            VStack(alignment: .leading, spacing: 18) {
                HStack(alignment: .top, spacing: 12) {
                    AgentDeckBrandMark(size: 26, tint: AgentDeckSettingsStyle.green, isAnimating: true, style: .duotone)
    ...
    private var debugBackground: some View {
        AgentDeckSettingsStyle.background
    }
...
private struct DebugActionButtonStyle: ButtonStyle {
    ...
    private func background(configuration: Configuration) -> Color {
        switch kind {
        case .primary:
            return AgentDeckSettingsStyle.green.opacity(configuration.isPressed ? 0.72 : 1)
        case .secondary:
