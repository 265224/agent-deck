...
struct AppearanceSettingsPane: View {
    ...
    private var usesNotchSurface: Bool { model.overlayPresentationMode == .notch }

    var body: some View {
        Form {
            Section(lang.t("settings.appearance.presentationMode")) {
                Picker(lang.t("settings.appearance.presentationMode"), selection: Binding(
                    get: { model.overlayPresentationMode },
                    set: { model.overlayPresentationMode = $0 }
                )) {
                    Text(lang.t("settings.appearance.presentationMode.notch")).tag(OverlayPresentationMode.notch)
                    Text(lang.t("settings.appearance.presentationMode.desktopPet")).tag(OverlayPresentationMode.desktopPet)
                }
                .pickerStyle(.segmented)

                Text(lang.t("settings.appearance.presentationMode.help"))
                    .font(.caption)
    ...
    private func pixelShapeTitle(_ style: IslandPixelShapeStyle) -> String {
        ...
        case .bear:   lang.t("settings.appearance.pixelShape.bear")
