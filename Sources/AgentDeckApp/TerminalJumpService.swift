...
struct TerminalJumpService {
    ...
    private static let knownApps: [TerminalAppDescriptor] = [
        ...
        TerminalAppDescriptor(
            ...
            aliases: ["catpaw"],
            alternateBundleIdentifiers: ["com.catpaw.cowork"]
        ),
        TerminalAppDescriptor(
            displayName: "VS Code",
    ...
    /// Bundle identifiers of VS Code family editors (VS Code, Insiders, Cursor, CatPaw, Windsurf, Trae).
    ...
    // MARK: - VS Code family (VS Code, Insiders, Cursor, CatPaw, Windsurf, Trae)
