...
Agent Deck ("the App") is a companion app for AI coding agents. We are committed to protecting your privacy.
...
https://github.com/265224/agent-deck/issues

---

## 中文

Agent Deck（"本应用"）是一款 AI 编程助手的配套应用。我们致力于保护您的隐私。
